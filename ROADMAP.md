...
- [x] **Фаза 2: Гібридна відмовостійкість** (AI Fallback на основі SARIMA, автоматичні повторні спроби DB).
...
- [x] **Дія**: Оптимізувати SQL-індекси для таблиці `LoadMeasurements` (Впроваджено у v3.1).
- [ ] **Дія**: Впровадити рівень кешування на базі Redis для масштабних сегментів історичних даних.
