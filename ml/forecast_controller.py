...
from ml.backtest import get_fast_backtest, evaluate_last_24h
...
def get_cached_history(sub, src):
    if src == "Kaggle" or src == "CSV":
        from core.analytics.aggregator import get_history_csv
        return get_history_csv(sub)
    from core.analytics.aggregator import get_history_live
