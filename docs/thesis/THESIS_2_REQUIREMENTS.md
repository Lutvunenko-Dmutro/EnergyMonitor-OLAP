...
### 2.4. SWOT-аналіз проєкту EnergyMonitor-OLAP
...
### 2.5. Порівняльний аналіз хмарних СУБД для предиктивного моніторингу
...
## 2.3. Обґрунтування видів забезпечення системи
...
![Рис. 2.2а. Процес підготовки та трансформації даних](../images/diag_activity_part1.png)
*Рис. 2.2а. Процес підготовки та трансформації даних*

![Рис. 2.2б. Процес інференсу та валідації прогнозу](../images/diag_activity_part2.png)
