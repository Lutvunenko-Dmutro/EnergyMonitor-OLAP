...
<div class="hero-section">
    ...
    <div class="hero-main">
        ...
        <div class="hero-title-group">
            <h1 class="mega-title">Служба автоматизації: logging_config</h1>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step">
        <p>Модуль <b>logging_config</b> забезпечує інтеграцію та виконання наступних обчислювальних процесів системи: <i>СИСТЕМА СПОСТЕРЕЖЕННЯ ТА АУДИТУ ПОДІЙ (Observability Core) Централізований модуль логування, що забезпечує прозорість роботи всіх вузлів системи.</i><br><br><b>Архітектурний інтерфейс:</b> надає методи <code>setup_logging()</code>, <code>_create_console_handler()</code>.</p>
    </div>
</div>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step" style="border-left: 4px solid var(--accent); padding-left: 20px;">
        <p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>СИСТЕМА СПОСТЕРЕЖЕННЯ ТА АУДИТУ ПОДІЙ (Observability Core)</p>
<p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>Централізований модуль логування, що забезпечує прозорість роботи всіх вузлів системи.</p>
...
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Multi-channel Logging:</b> одночасна трансляція логів у консоль, загальні файли та окремі звіти про помилки.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Log Rotation:</b> автоматичне керування розміром файлів (10MB) та зберігання архівів (Backup Count).</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Timed Rotation:</b> щоденне архівування подій для довгострокового аналізу стабільності.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Structured Formatting:</b> використання ANSI-кольорів та іконок для швидкої візуальної діагностики.</li>
</ol>
    </div>
</div>
    ...
    <div class="glass-card flow-step">
        ...
        <div style='display: flex; flex-direction: column; gap: 10px;'>
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                <code style='color: var(--accent); font-size: 13px; font-weight: 600;'>def setup_logging()</code>
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Централізоване налаштування логування.</p>
            </div>
            
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                <code style='color: var(--accent); font-size: 13px; font-weight: 600;'>def _create_console_handler()</code>
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Виконує обчислювальну операцію системи.</p>
            </div>
            
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                <code style='color: var(--accent); font-size: 13px; font-weight: 600;'>def _create_file_handler()</code>
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Виконує обчислювальну операцію системи.</p>
            </div>
            
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                <code style='color: var(--accent); font-size: 13px; font-weight: 600;'>def _create_error_handler()</code>
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Виконує обчислювальну операцію системи.</p>
            </div>
            
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                <code style='color: var(--accent); font-size: 13px; font-weight: 600;'>def _create_daily_handler()</code>
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Виконує обчислювальну операцію системи.</p>
            </div>
            
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                <code style='color: var(--accent); font-size: 13px; font-weight: 600;'>def _log_startup_banner()</code>
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Виконує обчислювальну операцію системи.</p>
            </div>
            </div>
    </div>
...
graph TD
    START("Запуск logging_config.py") --> CONFIG("Ініціалізація оточення")
