...
<div class="hero-section">
    ...
    <div class="hero-main">
        ...
        <div class="hero-title-group">
            <h1 class="mega-title">Служба автоматизації: sensors</h1>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step">
        <p>Модуль <b>sensors</b> забезпечує інтеграцію та виконання наступних обчислювальних процесів системи: <i>МОДУЛЬ ВІРТУАЛЬНОЇ ТЕЛЕМЕТРІЇ ТА СЕНСОРІВ (Virtual Hardware Instrumentation) Реалізує програмну імітацію фізичних датчиків високовольтного обладнання.</i><br><br><b>Архітектурний інтерфейс:</b> реалізує класи <code>SensorReading</code>, <code>VirtualHighVoltageSensor</code>.</p>
    </div>
</div>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step" style="border-left: 4px solid var(--accent); padding-left: 20px;">
        <p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>МОДУЛЬ ВІРТУАЛЬНОЇ ТЕЛЕМЕТРІЇ ТА СЕНСОРІВ (Virtual Hardware Instrumentation)</p>
<p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>Реалізує програмну імітацію фізичних датчиків високовольтного обладнання.</p>
...
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Physical Law Simulation:</b> імітація параметрів за законами фізики (Ohm's Law).</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Thermal Inertia Modeling:</b> модель теплової інерції — плавне нагрівання трансформаторів.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Health Degradation Logic:</b> оцінка стану на основі концентрації газів та перевантажень.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Operational States:</b> автоматичне визначення статусів роботи (OK, WARNING, CRITICAL).</li>
</ol>
<p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>Дозволяє отримати дані, ідентичні реальним сигналам з систем моніторингу SCADA.</p>
    </div>
</div>
    ...
    <div class="glass-card flow-step">
        <p style="margin-bottom: 15px; color: var(--text-dim);">Документовані класи та методи, знайдені за допомогою статичного аналізу коду (AST):</p>
            ...
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 15px; border-radius: 8px; margin-bottom: 15px;'>
                <span style='color: #fb923c; font-weight: bold;'>class SensorReading</span>
                <p style='margin: 5px 0 10px 0; font-size: 13.5px; color: var(--text-dim);'>Клас об'єктної моделі.</p>
                <div style='margin-left: 15px;'>
            </div></div>
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 15px; border-radius: 8px; margin-bottom: 15px;'>
                <span style='color: #fb923c; font-weight: bold;'>class VirtualHighVoltageSensor</span>
                <p style='margin: 5px 0 10px 0; font-size: 13.5px; color: var(--text-dim);'>Клас об'єктної моделі.</p>
                <div style='margin-left: 15px;'>
                    ...
                    <div style='margin-bottom: 8px; border-left: 2px solid var(--accent); padding-left: 10px;'>
                        <code style='color: var(--accent); font-weight: 600;'>def read_telemetry()</code>
                        <p style='margin: 2px 0 0 0; font-size: 12px; color: var(--text-dim);'>Метод класу.</p>
                    </div>
                </div></div>
    </div>
...
graph TD
    START("Запуск sensors.py") --> CONFIG("Ініціалізація оточення")
