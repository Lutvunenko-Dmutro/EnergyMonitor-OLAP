...
<div class="hero-section">
    ...
    <div class="hero-main">
        ...
        <div class="hero-title-group">
            <h1 class="mega-title">Служба автоматизації: analytics_advanced</h1>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step">
        <p>Модуль <b>analytics_advanced</b> забезпечує інтеграцію та виконання наступних обчислювальних процесів системи: <i>АНАЛІЗ ТРЕНДІВ ТА АСОЦІАТИВНИХ ПРАВИЛ (Trend & Association Rule Analysis) Автономний аналітичний сервіс для виявлення прихованих структурних зв'язків.</i><br><br><b>Архітектурний інтерфейс:</b> надає методи <code>analyze_trends()</code>, <code>analyze_association_rules()</code>.</p>
    </div>
</div>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step" style="border-left: 4px solid var(--accent); padding-left: 20px;">
        <p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>АНАЛІЗ ТРЕНДІВ ТА АСОЦІАТИВНИХ ПРАВИЛ (Trend & Association Rule Analysis)</p>
<p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>Автономний аналітичний сервіс для виявлення прихованих структурних зв'язків.</p>
...
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Temporal Trend Discovery:</b> аналіз тижневої динаміки для ідентифікації об'єктів з аномальним ростом.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Cascade Failure Identification:</b> пошук асоціативних правил для виявлення зон каскадного ризику.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Frequent Pattern Mining:</b> комбінаторний аналіз частоти спільних критичних подій.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Strategic Insights Generation:</b> висновки щодо структурної пов'язаності об'єктів енергосистеми.</li>
</ol>
<p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>Служить для превентивного виявлення вразливостей топології мережі.</p>
    </div>
</div>
    ...
    <div class="glass-card flow-step">
        ...
        <div style='display: flex; flex-direction: column; gap: 10px;'>
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                <code style='color: var(--accent); font-size: 13px; font-weight: 600;'>def analyze_trends()</code>
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Аналіз трендів споживання (Early Adopters).</p>
            </div>
            
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                <code style='color: var(--accent); font-size: 13px; font-weight: 600;'>def analyze_association_rules()</code>
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Пошук асоціативних правил (Каскадні аварії).</p>
            </div>
            </div>
    </div>
</div>
...
graph TD
    START("Запуск analytics_advanced.py") --> CONFIG("Ініціалізація оточення")
