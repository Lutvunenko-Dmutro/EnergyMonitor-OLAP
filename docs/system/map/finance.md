...
<div class="hero-section">
    ...
    <div class="hero-main">
        ...
        <div class="hero-title-group">
            <h1 class="mega-title">Служба автоматизації: finance</h1>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step">
        <p>Модуль <b>finance</b> забезпечує інтеграцію та виконання наступних обчислювальних процесів системи: <i>ФІНАНСОВИЙ АУДИТ ТА АНАЛІЗ МЕРЕЖЕВИХ ВТРАТ (Financial & Grid Analytics) Інтегрований модуль для моніторингу економічної ефективності та фізичного стану мереж.</i><br><br><b>Архітектурний інтерфейс:</b> надає методи <code>render()</code>.</p>
    </div>
</div>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step" style="border-left: 4px solid var(--accent); padding-left: 20px;">
        <p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>ФІНАНСОВИЙ АУДИТ ТА АНАЛІЗ МЕРЕЖЕВИХ ВТРАТ (Financial & Grid Analytics)</p>
<p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>Інтегрований модуль для моніторингу економічної ефективності та фізичного стану мереж.</p>
...
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Economic Audit:</b> візуалізація добової вартості генерації по регіонах на основі динамічних тарифів.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Grid Stability Monitor:</b> контроль завантаженості ЛЕП (AC/HVDC) з візуалізацією зон ризику (80-100%).</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Pricing Heatmaps:</b> аналіз погодинної волатильності цін для оптимізації споживання.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Loss Modeling:</b> візуалізація нелінійної залежності технічних втрат від рівня навантаження.</li>
</ol>
    </div>
</div>
    ...
    <div class="glass-card flow-step">
        ...
        <div style='display: flex; flex-direction: column; gap: 10px;'>
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                ...
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Рендеринг вкладки фінансів та стану мереж.</p>
            </div>
            </div>
    </div>
</div>
...
graph TD
    START("Запуск finance.py") --> CONFIG("Ініціалізація оточення")
