...
<div class="hero-section">
    ...
    <div class="hero-main">
        ...
        <div class="hero-title-group">
            <h1 class="mega-title">Служба автоматизації: consumption</h1>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step">
        <p>Модуль <b>consumption</b> забезпечує інтеграцію та виконання наступних обчислювальних процесів системи: <i>СИСТЕМА АНАЛІЗУ СПОЖИВАННЯ (Consumption Analytics Engine) Модуль для детальної візуалізації та статистичного аналізу навантаження мережі.</i><br><br><b>Архітектурний інтерфейс:</b> надає методи <code>render()</code>.</p>
    </div>
</div>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step" style="border-left: 4px solid var(--accent); padding-left: 20px;">
        <p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>СИСТЕМА АНАЛІЗУ СПОЖИВАННЯ (Consumption Analytics Engine)</p>
<p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>Модуль для детальної візуалізації та статистичного аналізу навантаження мережі.</p>
...
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Temporal Dynamics:</b> лінійні графіки споживання з підтримкою логарифмічних шкал та фасетної сітки.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Metric Normalization:</b> перемикання між абсолютними (МВт) та відносними (%) показниками навантаження.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Seasonal Slicing:</b> погодинні Boxplots для аналізу різниці споживання у робочі та вихідні дні.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Weather Correlation:</b> регресійний аналіз залежності енергоспоживання від температурних трендів.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Peak Detection:</b> автоматична анотація локальних та глобальних максимумів у обраному періоді.</li>
</ol>
    </div>
</div>
    ...
    <div class="glass-card flow-step">
        ...
        <div style='display: flex; flex-direction: column; gap: 10px;'>
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                ...
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Вкладка споживання з повним набором інструментів аналізу.</p>
            </div>
            </div>
    </div>
</div>
...
graph TD
    START("Запуск consumption.py") --> CONFIG("Ініціалізація оточення")
