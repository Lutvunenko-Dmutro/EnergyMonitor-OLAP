...
<div class="hero-section">
    ...
    <div class="hero-main">
        ...
        <div class="hero-title-group">
            <h1 class="mega-title">Служба автоматизації: data_table</h1>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step">
        <p>Модуль <b>data_table</b> забезпечує інтеграцію та виконання наступних обчислювальних процесів системи: <i>КОМПОНЕНТ ПРЕДСТАВЛЕННЯ АРХІВНИХ ДАНИХ (Archive Data Table) Модуль реалізує інтерфейс для детального перегляду та експорту первинних даних.</i><br><br><b>Архітектурний інтерфейс:</b> надає методи <code>render_raw_data_table()</code>.</p>
    </div>
</div>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step" style="border-left: 4px solid var(--accent); padding-left: 20px;">
        <p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>КОМПОНЕНТ ПРЕДСТАВЛЕННЯ АРХІВНИХ ДАНИХ (Archive Data Table)</p>
<p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>Модуль реалізує інтерфейс для детального перегляду та експорту первинних даних.</p>
...
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Raw Data Presentation:</b> інтерактивна таблиця зі стилізацією числових показників та локалізацією.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Intelligent Mapping:</b> перетворення технічних ідентифікаторів БД на зрозумілі оператору назви.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Export Management:</b> вбудований механізм генерації та завантаження CSV-звітів за довільний період.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>UI Resilience:</b> автоматична обробка пропущених значень та адаптивна висота для великих масивів.</li>
</ol>
<p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>Забезпечує прозорість аналітики через прямий доступ до першоджерел даних системи.</p>
    </div>
</div>
    ...
    <div class="glass-card flow-step">
        ...
        <div style='display: flex; flex-direction: column; gap: 10px;'>
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                <code style='color: var(--accent); font-size: 13px; font-weight: 600;'>def render_raw_data_table()</code>
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Renders the interactive data table and download button for the Digital Archive.</p>
            </div>
            </div>
    </div>
</div>
...
graph TD
    START("Запуск data_table.py") --> CONFIG("Ініціалізація оточення")
