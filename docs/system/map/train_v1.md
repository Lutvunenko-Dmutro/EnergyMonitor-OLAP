...
<div class="hero-section">
    ...
    <div class="hero-main">
        ...
        <div class="hero-title-group">
            <h1 class="mega-title">Служба автоматизації: train_v1</h1>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step">
        <p>Модуль <b>train_v1</b> забезпечує інтеграцію та виконання наступних обчислювальних процесів системи: <i>🧠 BASELINE NEURAL TRAINING (Legacy LSTM V1). Модуль реалізує спрощену архітектуру нейронної мережі для порівняльного аналізу. Ключові можливості:</i><br><br><b>Архітектурний інтерфейс:</b> надає методи <code>get_paths()</code>, <code>load_v1_data()</code>.</p>
    </div>
</div>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step" style="border-left: 4px solid var(--accent); padding-left: 20px;">
        <p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>🧠 BASELINE NEURAL TRAINING (Legacy LSTM V1).</p>
<p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>Модуль реалізує спрощену архітектуру нейронної мережі для порівняльного аналізу.</p>
...
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Univariate Data Ingestion:</b> завантаження сумарного навантаження як єдиної часової ознаки.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Baseline Architecture:</b> побудова дворівневої LSTM-мережі для вивчення базових циклів.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Comparative Analysis:</b> автоматичне порівняння точності з класичним ARIMA-бейзлайном.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Scientific Verification:</b> проведення оцінки на 14-денному вікні (336 годин) з генерацією звітів.</li>
</ol>
<p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>Служить для демонстрації еволюції архітектур та обґрунтування переходу до багатовимірних моделей (V3).</p>
    </div>
</div>
    ...
    <div class="glass-card flow-step">
        ...
        <div style='display: flex; flex-direction: column; gap: 10px;'>
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                <code style='color: var(--accent); font-size: 13px; font-weight: 600;'>def get_paths()</code>
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Виконує обчислювальну операцію системи.</p>
            </div>
            
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                <code style='color: var(--accent); font-size: 13px; font-weight: 600;'>def load_v1_data()</code>
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Витягує тільки навантаження з бази (1 ознака).</p>
            </div>
            
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                <code style='color: var(--accent); font-size: 13px; font-weight: 600;'>def create_sequences()</code>
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Виконує обчислювальну операцію системи.</p>
            </div>
            
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                <code style='color: var(--accent); font-size: 13px; font-weight: 600;'>def train_and_evaluate()</code>
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Виконує обчислювальну операцію системи.</p>
            </div>
            </div>
    </div>
...
graph TD
    START("Запуск train_v1.py") --> CONFIG("Ініціалізація оточення")
