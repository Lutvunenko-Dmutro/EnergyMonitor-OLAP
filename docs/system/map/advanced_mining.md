...
<div class="hero-section">
    ...
    <div class="hero-main">
        ...
        <div class="hero-title-group">
            <h1 class="mega-title">Служба автоматизації: advanced_mining</h1>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step">
        <p>Модуль <b>advanced_mining</b> забезпечує інтеграцію та виконання наступних обчислювальних процесів системи: <i>СЕРВІС ПОГЛИБЛЕНОГО МАШИННОГО НАВЧАННЯ (Advanced Machine Learning Analytics) Модуль реалізує складні алгоритми інтелектуального аналізу даних для виявлення патернів.</i><br><br><b>Архітектурний інтерфейс:</b> надає методи <code>get_db_connection()</code>, <code>get_data()</code>.</p>
    </div>
</div>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step" style="border-left: 4px solid var(--accent); padding-left: 20px;">
        <p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>СЕРВІС ПОГЛИБЛЕНОГО МАШИННОГО НАВЧАННЯ (Advanced Machine Learning Analytics)</p>
<p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>Модуль реалізує складні алгоритми інтелектуального аналізу даних для виявлення патернів.</p>
...
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Multivariate Clustering (K-Means):</b> групування підстанцій за навантаженням та аварійністю.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Predictive Classification (Decision Tree):</b> прогноз ймовірності критичних станів (What-If).</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Decision Path Visualization:</b> генерація дерев рішень для Explainable AI аналізу.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Automated Risk Assessment:</b> розрахунок статистичних звітів точності класифікації.</li>
</ol>
<p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>Використовується для стратегічного планування та розширеної діагностики ризиків.</p>
    </div>
</div>
    ...
    <div class="glass-card flow-step">
        ...
        <div style='display: flex; flex-direction: column; gap: 10px;'>
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                <code style='color: var(--accent); font-size: 13px; font-weight: 600;'>def get_db_connection()</code>
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Безпечне підключення до БД.</p>
            </div>
            
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                <code style='color: var(--accent); font-size: 13px; font-weight: 600;'>def get_data()</code>
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Отримання даних у DataFrame.</p>
            </div>
            
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                <code style='color: var(--accent); font-size: 13px; font-weight: 600;'>def run_clustering_analysis()</code>
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Кластеризація підстанцій (K-Means).</p>
            </div>
            
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                <code style='color: var(--accent); font-size: 13px; font-weight: 600;'>def run_classification_prediction()</code>
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Побудова дерева рішень (Decision Tree) з КОМПАКТНИМ дизайном.</p>
            </div>
            </div>
    </div>
</div>
...
graph TD
    START("Запуск advanced_mining.py") --> CONFIG("Ініціалізація оточення")
