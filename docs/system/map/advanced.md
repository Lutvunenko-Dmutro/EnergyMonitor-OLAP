...
<div class="hero-section">
    ...
    <div class="hero-main">
        ...
        <div class="hero-title-group">
            <h1 class="mega-title">Служба автоматизації: advanced</h1>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step">
        <p>Модуль <b>advanced</b> забезпечує інтеграцію та виконання наступних обчислювальних процесів системи: <i>СИСТЕМА ІНТЕЛЕКТУАЛЬНОГО АНАЛІЗУ ТА СЕГМЕНТАЦІЇ (Advanced AI Analytics) Модуль для глибокої аналітики енергосистеми з використанням AI-методів.</i><br><br><b>Архітектурний інтерфейс:</b> надає методи <code>fragment_advanced_tab1()</code>, <code>fragment_advanced_tab2()</code>.</p>
    </div>
</div>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step" style="border-left: 4px solid var(--accent); padding-left: 20px;">
        <p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>СИСТЕМА ІНТЕЛЕКТУАЛЬНОГО АНАЛІЗУ ТА СЕГМЕНТАЦІЇ (Advanced AI Analytics)</p>
<p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>Модуль для глибокої аналітики енергосистеми з використанням AI-методів.</p>
...
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Clustering & Segmentation:</b> автоматичне групування підстанцій за патернами профілів навантаження.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Trend Decomposition:</b> декомпозиція часових рядів на трендову, сезонну та залишкову складові.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Fragment-based UI:</b> стабільний рендеринг важких аналітичних вкладок через ізольовані фрагменти.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Multidimensional Analysis:</b> підтримка логарифмічного масштабування та відносних метрик для порівняльного аналізу.</li>
</ol>
    </div>
</div>
    ...
    <div class="glass-card flow-step">
        ...
        <div style='display: flex; flex-direction: column; gap: 10px;'>
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                <code style='color: var(--accent); font-size: 13px; font-weight: 600;'>def fragment_advanced_tab1()</code>
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Фрагмент для вкладки кластеризації.</p>
            </div>
            
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                <code style='color: var(--accent); font-size: 13px; font-weight: 600;'>def fragment_advanced_tab2()</code>
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Фрагмент для вкладки аналізу трендів.</p>
            </div>
            
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                <code style='color: var(--accent); font-size: 13px; font-weight: 600;'>def render_advanced_analysis()</code>
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Dispatcher for advanced AI analytics tabs.</p>
            </div>
            </div>
    </div>
</div>
...
graph TD
    START("Запуск advanced.py") --> CONFIG("Ініціалізація оточення")
...
<div class="section-container">
    ...
    <div class="glass-card flow-step">
        ...
        <div style="background: rgba(0,0,0,0.2); padding: 12px; border-radius: 8px; border: 1px solid var(--border);">
            <span style='display: inline-block; background: rgba(56, 189, 248, 0.1); border: 1px solid rgba(56, 189, 248, 0.2); padding: 4px 10px; border-radius: 6px; font-family: "JetBrains Mono", monospace; font-size: 12px; color: var(--accent); margin: 4px;'>src.ui.views.advanced_components.clustering_view</span><span style='display: inline-block; background: rgba(56, 189, 248, 0.1); border: 1px solid rgba(56, 189, 248, 0.2); padding: 4px 10px; border-radius: 6px; font-family: "JetBrains Mono", monospace; font-size: 12px; color: var(--accent); margin: 4px;'>src.ui.views.advanced_components.trend_view</span><span style='display: inline-block; background: rgba(56, 189, 248, 0.1); border: 1px solid rgba(56, 189, 248, 0.2); padding: 4px 10px; border-radius: 6px; font-family: "JetBrains Mono", monospace; font-size: 12px; color: var(--accent); margin: 4px;'>streamlit</span>
        </div>
    </div>
</div>
