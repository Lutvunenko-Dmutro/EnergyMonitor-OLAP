...
<div class="hero-section">
    ...
    <div class="hero-main">
        ...
        <div class="hero-title-group">
            <h1 class="mega-title">Служба автоматизації: generation</h1>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step">
        <p>Модуль <b>generation</b> забезпечує інтеграцію та виконання наступних обчислювальних процесів системи: <i>СИСТЕМА ВІЗУАЛІЗАЦІЇ СТРУКТУРИ ГЕНЕРАЦІЇ (Generation Mix Monitor) Забезпечує багатовимірний аналіз джерел електроенергії та їх розподілу.</i><br><br><b>Архітектурний інтерфейс:</b> надає методи <code>render()</code>.</p>
    </div>
</div>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step" style="border-left: 4px solid var(--accent); padding-left: 20px;">
        <p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>СИСТЕМА ВІЗУАЛІЗАЦІЇ СТРУКТУРИ ГЕНЕРАЦІЇ (Generation Mix Monitor)</p>
<p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>Забезпечує багатовимірний аналіз джерел електроенергії та їх розподілу.</p>
<h3 style='color: var(--accent); font-family: "Orbitron", sans-serif; font-size: 15px; margin-top: 22px; margin-bottom: 10px;'>Ключові візуалізації</h3>
<ol style='margin-left: 20px; margin-bottom: 15px;'>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Sankey Diagram:</b> інтерактивне відображення потоків потужності від типів джерел до регіонів.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Pie Mix Chart:</b> аналіз процентної частки джерел (Energy Mix) у загальному балансі системи.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Stacked Area Chart:</b> динаміка вироблення енергії з розбивкою за категоріями (Nuclear, Thermal, RES).</li>
</ol>
<p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>Використовує єдину систему колірної ідентифікації для всіх графіків (Master Colors).</p>
    </div>
</div>
    ...
    <div class="glass-card flow-step">
        ...
        <div style='display: flex; flex-direction: column; gap: 10px;'>
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                ...
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Рендеринг вкладки генерації.</p>
            </div>
            </div>
    </div>
</div>
...
graph TD
    START("Запуск generation.py") --> CONFIG("Ініціалізація оточення")
