...
<div class="hero-section">
    ...
    <div class="hero-main">
        ...
        <div class="hero-title-group">
            <h1 class="mega-title">Служба автоматизації: map</h1>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step">
        <p>Модуль <b>map</b> забезпечує інтеграцію та виконання наступних обчислювальних процесів системи: <i>МОДУЛЬ ГЕОПРОСТОРОВОЇ ВІЗУАЛІЗАЦІЇ (Geospatial Grid Monitor) Забезпечує інтерактивне відображення об'єктів енергосистеми на карті України.</i><br><br><b>Архітектурний інтерфейс:</b> надає методи <code>render()</code>.</p>
    </div>
</div>
...
<div class="section-container">
    ...
    <div class="glass-card flow-step" style="border-left: 4px solid var(--accent); padding-left: 20px;">
        <p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>МОДУЛЬ ГЕОПРОСТОРОВОЇ ВІЗУАЛІЗАЦІЇ (Geospatial Grid Monitor)</p>
<p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>Забезпечує інтерактивне відображення об'єктів енергосистеми на карті України.</p>
<h3 style='color: var(--accent); font-family: "Orbitron", sans-serif; font-size: 15px; margin-top: 22px; margin-bottom: 10px;'>Підтримує два режими моніторингу</h3>
<ol style='margin-left: 20px; margin-bottom: 15px;'>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Статус-маркери:</b> візуалізація завантаження та техстану через колірні та розмірні індикатори.</li>
<li style='margin-bottom: 6px; line-height: 1.5;'><b>Heatmap:</b> теплова карта щільності споживання потужності по регіонах.</li>
</ol>
<p style='line-height: 1.7; margin-bottom: 12px; color: var(--text-main);'>Інтегрується з Mapbox для забезпечення високої продуктивності та сучасного Dark-дизайну.</p>
    </div>
</div>
    ...
    <div class="glass-card flow-step">
        ...
        <div style='display: flex; flex-direction: column; gap: 10px;'>
            <div style='background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 12px; border-radius: 8px;'>
                ...
                <p style='margin: 4px 0 0 0; font-size: 12.5px; color: var(--text-dim);'>Малює карту з можливістю перемикання режимів.</p>
            </div>
            </div>
    </div>
</div>
...
graph TD
    START("Запуск map.py") --> CONFIG("Ініціалізація оточення")
