...
*   [**Повний текст дипломної роботи (Markdown)**](docs/thesis/THESIS_0_INTRODUCTION.md) — Перехід до читання розділів.
*   [**План кваліфікаційної роботи**](docs/DIPLOMA_PLAN.md) — Структура та етапи розробки.

### 🧬 Наукова новизна та практичне значення
1. **Гібридне моделювання (Digital Twin + ML):** Система поєднує стохастичний прогноз (LSTM-мережі) з детермінованими фізичними моделями мережі (розрахунок втрат потужності AC/HVDC, температурна деградація).
2. **Cloud-Native масштабованість для Smart City:** Успішне розгортання в хмарі (**Render**) демонструє готовність системи до інтеграції в муніципальні сервіси як SaaS-платформи.
