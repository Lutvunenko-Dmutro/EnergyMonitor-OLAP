...
* **Візуалізація:** Plotly Express & Graph Objects (WebGL прискорення)
* **База даних:** PostgreSQL
* **ETL & Data Processing:** Pandas, NumPy, SQLAlchemy
* **Статистика та ML:** Statsmodels (OLS регресія)
...
```bash
git clone [https://github.com/Lutvunenko-Dmutro/EnergyMonitor-OLAP.git](https://github.com/Lutvunenko-Dmutro/EnergyMonitor-OLAP.git)
