...
### 📚 Пояснювальна записка (3 розділи за МНТУ)
Повний текст документації, оформлений згідно з ДСТУ 8302:2015 та вимогами кафедри:

1.  📄 [**РЕФЕРАТ ТА ВСТУП**](docs/thesis/THESIS_0_ABSTRACT.md) — Мета, об'єкт та обґрунтування.
2.  📘 [**РОЗДІЛ 1. ТЕОРЕТИЧНИЙ АНАЛІЗ**](docs/thesis/THESIS_1_THEORY.md) — Огляд Digital Twin та методів ML.
3.  📙 [**РОЗДІЛ 2. ТЕХНІЧНЕ ЗАВДАННЯ**](docs/thesis/THESIS_2_REQUIREMENTS.md) — Формальні вимоги та ТЗ (без коду).
4.  📗 [**РОЗДІЛ 3. ПРОЄКТНІ РІШЕННЯ**](docs/thesis/THESIS_3_DESIGN_AND_IMPLEMENTATION.md) — Математика LSTM, UI та результати.
5.  🏁 [**ВИСНОВКИ ТА ДЖЕРЕЛА**](docs/thesis/THESIS_FINAL_CONCLUSIONS.md) — Загальні підсумки та Бібліографія.
6.  📎 [**ДОДАТКИ**](docs/thesis/APPENDICES.md) — Тексти програм та лістинги коду.
